  ...
  $.fn.extend({
    ...
    loadStep: function(params){
      ...
      var baseHtml =  "<div class='ystep-container'>"+
                      ...
                      "</div>";
      //步骤框架
      //var stepHtml = "<li class='ystep-step ystep-step-undone' " +
      //    "data-container='body' " +
      //    "data-toggle='popover' data-placement='top' data-title='' " +
      ...
      var logic = {
        size: {
          ...
          large: function($html){
            var width = 140;
            var stepCount = $html.find("li").length-1,
            containerWidth = ((stepCount+1)*width)+"px",
            progressWidth = (stepCount*width)+"px";
      ...
      $(this).each(function(i,n){
        ...
        for(i=0;i<arrayLength;i++){
          ...
          var html = "<a class='content'>"+_s.title+"</a>"
          $stepHtml.html(html);
          //将步骤插入到步骤列表中
    ...
    setStep: function(step) {
      $(this).each(function(i,n){
        ...
        if(1<=step && step<=$steps.length){
          //更新进度
          var scale = "%";
          //scale = Math.round((step-1)*150/($steps.length-1))+scale;

          scale = ((step-1)/($steps.length-1) *100)+scale;
