/**
 * Created by Ivan on 14-8-23.
 */
/*global plupload */
/*global qiniu */
function FileProgress(file,i, targetID) {
...
//        var actionCancle = $("<td/>");
//        actionCancle.html("<button class='btn btn-danger' onclick='removeFile("+this.fileProgressID+")'>删除</button>");


        Wrappeer.append(progressText);
        Wrappeer.append(progressSize);
        Wrappeer.append(progressBarTd);
//        Wrappeer.append(actionCancle);
