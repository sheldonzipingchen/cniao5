define(function(require, exports, module) {
    ...
    exports.run = function() {
        ...
        var removeNavMobile = function(){
            ...
            $("html,.cniao-wrap").removeClass("nav-active");
        }
        ...
        $(".js-navbar-more").click(function(e){
            ...
            if($nav.hasClass("active")){
                ...
                $("html,.cniao-wrap").addClass("nav-active");
            }
        });
        ...
        if(is_login && (".follow-btn").length>0){

            var $btn = $(".follow-btn");
            var statusCheckUrl = $btn.data('status-url');

            if(statusCheckUrl =='' || statusCheckUrl==undefined)
                return ;
        ...
        $('body').on('click', '.follow-btn', function(){
            ...
            if(!is_login){
                Notify.warning("请新登录,如已经登录,请刷新页面");
                return
            }
