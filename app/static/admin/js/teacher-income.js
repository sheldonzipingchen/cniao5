...
define(function(require, exports, module) {
    ...
    var base_url="/admin/teacher/incomes?"
    ...
    function initData(){
        ...
        $("#data-list").setTemplateURL("/static/jtemplate/admin/teacher-income.html?d="+(+new Date()));
    ...
    function buildUrl(){
        ...
        var email_or_mobi=$("#email_or_mobi").val()
         ...
         var url=base_url+ '&email_or_mobi='+email_or_mobi+ '&page_index='
