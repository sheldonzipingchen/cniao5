...
def create_direct_pay_by_user(tn, subject, body, total_fee, return_url, notify_url):
    """ 即时到账交易接口 """
    params = {}
...
def create_direct_pay_by_clazz(tn, subject, body, total_fee):
    """ 即时到账交易接口 """
    params = {}
    params['service'] = 'create_direct_pay_by_user'
    params['payment_type'] = '1'
    ...
    params['partner'] = Settings.ALIPAY_PARTNER
    params['seller_email'] = Settings.ALIPAY_SELLER_EMAIL
    params['return_url'] = Settings.ALIPAY_CLAZZ_RETURN_URL
    params['notify_url'] = Settings.ALIPAY_CLAZZ_NOTIFY_URL
